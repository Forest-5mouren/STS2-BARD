...
public sealed class BardCardPool : TypeListCardPoolModel, IModColorfulPhilosophersCardPool
{
    ...
    // 如果你想用原版卡框换色，加这两行
    private static readonly Material? _poolFrameMaterial = MaterialUtils.CreateReplaceHueShaderMaterial(0.702f, 0.616f, 0.859f);
